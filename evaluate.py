...
def get_arguments():
    ...
    # Data Preference
    parser.add_argument("--data-dir", type=str, default='/home/tsl/data/HumanParsing/mada_shhq_cihp_20')
    ...
    parser.add_argument("--model-restore", type=str, default='/home/tsl/project/parsing_infer/checkpoint/swin_base_150.pth.tar')
    parser.add_argument("--gpu", type=str, default='0', help="choose gpu device.")
    parser.add_argument("--save-results", default=False, action="store_true", help="whether to save the results.")

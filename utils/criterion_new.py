...
class CriterionAll(nn.Module):
    ...
    def parsing_loss(self, preds, target, hwgt=None, cycle_n=None):
        """
    ...
    def forward(self, preds, target, cycle_n=None, hwgt=None):
        loss = self.parsing_loss(preds, target, hwgt, cycle_n)
        return loss
